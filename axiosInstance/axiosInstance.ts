...
// import { AuthRefreshPostRequest, AuthRefreshPostResponse } from "../dtos/auth";
...
export const axiosInstance = axios.create({
  ...
  baseURL: process.env.NEXT_PUBLIC_APP_DEV_URL,
  timeout: TIMEOUT,
});
...
//   if (refreshToken) {
//     try {
//       const requestBody: AuthRefreshPostRequest = {
//         refreshToken: refreshToken,
//       };
//       const { data } = await axiosForRefreshToken.post<AuthRefreshPostResponse>(
